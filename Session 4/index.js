...
// Bai 3.2
// The hits property is an Object.
...

{
   ...
   {if (dict.hasOwnProperty(keyword)){
        ...
        let explain = prompt(`We could not find your word: ${keyword}, leave your explanation`);
        dict[keyword] = explain;
        alert ('Done');
